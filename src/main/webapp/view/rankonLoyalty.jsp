...
<div class="w3-row-padding">
	...
	<div class="w3-twothird">
		...
		<h1>Ranking based on Loyalty</h1>
		</div>
	...
	<div class="w3-container w3-card w3-border-left w3-border-yellow w3-margin-top w3-padding-0" style="margin-left:10px;padding-left:26px;">
		...
		<br>
        <span >
        <a class="w3-button w3-theme-d1 w3-margin-bottom" style="background-color: #629FAF ;" href="rankonExp?id=${job.jobId}"> Experience   </a><br>
		<a class="w3-button w3-theme-d1 w3-margin-bottom" style="background-color: #629FAF ;" href="rankonSkills?id=${job.jobId}"> Skills    </a><br>
			 <a class="w3-button w3-theme-d1 w3-margin-bottom" style="background-color: #629FAF ;" href="homeLIn"> Back to Profile  </a>
        </span>
	</div>
