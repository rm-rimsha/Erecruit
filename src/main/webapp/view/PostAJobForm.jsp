		...
		<div class="back3">
			...
			<div class="back2inner">
		        ...
		        <h2>Job Details</h2>
					...
					<form:form action="submitJob" method="post" modelAttribute="job" >
					
					      <div id="grad0">
					      <p style="color:white;font-size:25px;font-family: 'Open Sans', sans-serif">
					      Job Position
					      <tr>
					      <td><form:input path="jobPosition" type="text"/></td>
					      </tr> 
					      </div>
					      
					      <div id="grad0">
					      <p style="color:white;font-size:18px;">
					      Explain the skills required for the job. (Commas separated)
					      <tr>
					      <td><form:input path="skillsRequired" type="text" /></td>
					      </tr> 
					      </div>
					      ...
					      <tr>
					      <td><form:input path="eduReq" type="text" /></td>
					      </tr> 
					      </div>
					      
					      <div id="grad0">
					      <p style="color:white;font-size:18px;">
					      Minimum Experience (in years) required for the job.
					      <tr>
					      <td><form:input path="expReq" type="text" /></td>
					      </tr> 
					      </div>
					      ...
					      <tr>
					      <td><form:input path="JobDescription" type="text" /></td>
					      </tr> 
					      </div>
