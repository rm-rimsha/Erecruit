...
<div class="back3">
    ...
    <div class="back2">
        <div class="back2inner">
            <h2>Dispproved Jobs</h2>
            <p class="button1" style="cursor: auto; border: none;  " > Jobs you have disapproved are following: </p>
            <div class="table-wrapper">
                <table class="fl-table">
                    ...
                    <tbody>
                    <c:forEach var="ajob" items="${djobs}">
                        <tr>
