		...
		<div class="back3">
			...
			<div class="back2inner">
		        ...
		        <h2>Client Registration</h2>
					...
					<form:form action="CompleteClientRegistration" method="post" modelAttribute="RegisterClient" >
					      ...
					      Enter your CNIC
					      <tr>
					      <td><form:input path="CNIC" type="text"/></td>
					      </tr> 
					      </p>
					      </div>
					      ...
					      <tr>
					      <td><form:input path="officeAddress" type="text"/></td>
					      </tr> 
					      </p>
					      </div>
