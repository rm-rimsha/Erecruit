...
<body>
	...
	<%-- <form:form  action="saveCanUser" method="post" modelAttribute="candidateUser"> --%>
		...
		<form:form action="saveCandidate" method="post"
			...
			<div id="grad0">
				<p style="color: white; font-size: 25px;">
					<tr>
						<td>CNIC:</td>
						<td><form:input path="cnic"
								placeHolder="Enter your cnic (e.g 3840*********)" /></td>
					</tr>
			</div>
			...
			<div id="grad0">
				<p style="color: white; font-size: 25px;">
					<tr>
						<td>Education:</td>
						<td><form:input path="education"
								placeHolder="Enter your education" /></td>
					</tr>
				</p>
			</div>
				...
				<p style="color: white; font-size: 25px;">
					<tr>
						...
						<td><form:input path="experience"
								placeHolder="Enter your experience years" /></td>
					</tr>
				</p>
			</div>
			...
			<!--            <a href = "showCompanySuccess">SUBMIT</a> -->
			...
			<div id="grad0">
				<p style="color: white; font-size: 20px; text-align: center;">
					<tr>
						...
						<br>
						<td>Again proceeding to the Candidates Form, you will enter
							the remaining candidates data.</td>
					</tr>
				</p>
			</div>
